...
const About = () => {
  ...
  return (
    <section className='about section mt-16 h-screen flex items-center justify-center' id='about'>
      <div className="h-fit w-fit">
        ...
        <div className='about__container container grid mt-8'>
          ...
          <div className='about__data'>
            ...
            <a href={CV} download='' className='hover:px-12 transition-all bg-zinc-900 dark:bg-zinc-900 ring-1 text-sm ring-zinc-50  text-white p-4 rounded-sm button--flex'>
              Download CV
              <svg
