        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            ...
            <div className="contact__card dark:bg-zinc-900 bg-white">
              ...
              <a href="https://web.whatsapp.com" className="contact__button dark:text-stone-400">Enviar <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
            </div>
                ...
                <button href='#contact' className='bg-zinc-900 dark:bg-white dark:text-zinc-950 text-white button button--flex'>Enviar Mensagem
                  ...
                  >
                    <path
                      ...
                      class="dark:stroke-zinc-950 dark:fill-zinc-950 fill-white stroke-white"
                    ></path>
                    <path
